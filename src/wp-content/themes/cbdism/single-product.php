  ...
  <main class="main">
    ...
    <section class="product_store">
      <div class="container">
        ...
        <ul>
          <?php foreach($treat_stores as $treat_store) :
            ?>
          <li class="item d-flex">
            ...
            <div class="text_container">
              ...
              <div class="star_rating"><?php echo number_format($level, 1);?>
                <span class="star">
                  <?php echo $stars;?>
              ...
              <p class="price">
                <span class="price_value"><?php echo $treat_store['store-price'];?></span><span>円</span> （税込み）
              </p>
            </div>

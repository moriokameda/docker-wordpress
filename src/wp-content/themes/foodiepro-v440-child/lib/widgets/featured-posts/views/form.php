...
<div class="foodie-pro-widget-box">
	...
	<p>
		...
		<input type="text" id="<?php $this->field_id( 'more_from_category_text' ); ?>" name="<?php $this->field_name( 'more_from_category_text' ); ?>" value="<?php echo esc_attr( $data['more_from_category_text'] ); ?>" class="widefat" /><br/>
		Note: do NOT use generic "View More" text here - this is a hyperlink to your category page and should use text specific to that particular category (eg. "More Breakfast Recipes")
	</p>

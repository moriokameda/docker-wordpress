...
function foodie_pro_archive_maybe_remove_info() {
	...
	if ( ! get_theme_mod( 'foodie_pro_archive_show_info', false ) ) {
...
function foodie_pro_archive_maybe_remove_content() {
	...
	if ( ! get_theme_mod( 'foodie_pro_archive_show_content', false ) ) {
...
function foodie_pro_archive_maybe_remove_meta() {
	...
	if ( ! get_theme_mod( 'foodie_pro_archive_show_meta', false ) ) {
...
function foodie_pro_archive_maybe_move_image() {
	...
	$image_placement = get_theme_mod( 'foodie_pro_archive_image_placement', 'before_title' );
